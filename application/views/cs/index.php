        ...
        <div id="main">
                                    ...
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <h6 class="font-extrabold mb-0">1872</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-hover table-lg">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="col-auto">
                                                            <p class=" mb-0">Layanannya baik banget!!!</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="col-3">
                                                        ...
                                                        <td class="col-auto">
                                                            <p class=" mb-0">Cepat dan tidak ribet</p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="card">
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Afif</h5>
                                        <h6 class="text-muted mb-0">@afenk27</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a href="http://instagram.com/afenk27/">Afif</a></p>
                    </div>
                </div>
            </footer>
        </div>
